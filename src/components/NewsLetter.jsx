        ...
        <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto bg-white my-12 py-16">
            <div className="text-center">
                ...
                <div className="flex justify-center items-center gap-4 mt-6">
                    {/* Use button and handle navigation with onClick */}
                    <button 
                        onClick={handleContactClick}
                        className="btn-primary text-white font-semibold py-3 px-6 rounded-lg flex items-center hover:bg-brandPrimary-dark transition-all duration-300 shadow-lg"
                    >
                        Contact Us
                        <svg 
                            className="ml-2" 
